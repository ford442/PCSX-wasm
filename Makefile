CC=emcc
CXX=em++
CFLAGS= --closure 0 -sSUPPORT_BIG_ENDIAN=0 -s FULL_ES3=1 -sMAX_WEBGL_VERSION=2 -sMIN_WEBGL_VERSION=2 -s WEBGL2_BACKWARDS_COMPATIBILITY_EMULATION=1 -sGL_TESTING=1 -ffast-math -D USESDLSOUND -Wpointer-sign -sFORCE_FILESYSTEM=1 -lidbfs.js \
-sOFFSCREEN_FRAMEBUFFER=1 -sELIMINATE_DUPLICATE_FUNCTIONS=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=1400mb -sMALLOC="emmalloc" \
-sUSE_SDL=1 -sUSE_WEBGL2=1 -O3 -Wno-unused-result -s USE_ZLIB=1 -I./include -I./libpcsxcore
LDFLAGS=
