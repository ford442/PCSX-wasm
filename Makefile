CC=emcc
CXX=em++
CFLAGS= --closure 0 -sLEGACY_GL_EMULATION=0 -sFULL_ES2=0 -sFULL_ES3=0 -sOFFSCREEN_FRAMEBUFFER=0 -sGL_TESTING=1 -D USESDLSOUND -Wpointer-sign -sFORCE_FILESYSTEM=1 -lidbfs.js \
