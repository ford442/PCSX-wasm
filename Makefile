CC=emcc
CXX=em++
CFLAGS= -sFULL_ES2=1 -sFULL_ES3=1 -sGL_TESTING=1 -D USESDLSOUND -Wpointer-sign -sFORCE_FILESYSTEM=1 \
-sUSE_WEBGL2=1 -sOFFSCREEN_FRAMEBUFFER=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sELIMINATE_DUPLICATE_FUNCTIONS=1 \
-ffast-math -sUSE_SDL=2 -O3 -Wno-unused-result -s USE_ZLIB=1 -I./include -I./libpcsxcore
LDFLAGS=
