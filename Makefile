CC=emcc
CFLAGS= -sUSE_SDL=2 -O3 -Wno-unused-result  -lidbfs.js -sAGGRESSIVE_VARIABLE_ELIMINATION=1 -sELIMINATE_DUPLICATE_FUNCTIONS=1 \
...
WORKER_FLAGS= -sUSE_SDL=2  --post-js js/worker_funcs.js -sINITIAL_MEMORY=1400mb -s "EXPORTED_RUNTIME_METHODS=['cwrap','ccall','getValue','setValue']" -s EXPORTED_FUNCTIONS=$(WORKER_EXPORT)
