CC=emcc
CXX=em++
CFLAGS= --closure 0 -sFULL_ES2=1 -sFULL_ES3=1 -sMAX_WEBGL_VERSION=2 -sMIN_WEBGL_VERSION=2 -sGL_TESTING=1 -D USESDLSOUND -Wpointer-sign -sFORCE_FILESYSTEM=1 -lidbfs.js \
