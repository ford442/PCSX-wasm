CC=emcc
CXX=em++
CFLAGS= -sMAXIMUM_MEMORY=4gb -sWASM_BIGINT=1 -sSUPPORT_BIG_ENDIAN=1 -pthread -sPTHREAD_POOL_SIZE=2 -D USESDLSOUND -Wpointer-sign -sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sAGGRESSIVE_VARIABLE_ELIMINATION=1 -sELIMINATE_DUPLICATE_FUNCTIONS=1 -sPRINTF_LONG_DOUBLE=1 -sSUPPORT_LONGJMP=0 -sASSERTIONS=0 -flto -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=1400mb -ffast-math -sUSE_SDL=1 -Os -Wno-unused-result -sFORCE_FILESYSTEM=1 -s USE_ZLIB=1 -I./include -I./libpcsxcore
LDFLAGS=
