CC=emcc
CFLAGS= -sAGGRESSIVE_VARIABLE_ELIMINATION=1 -sELIMINATE_DUPLICATE_FUNCTIONS=1 -fno-rtti -fno-exceptions -sSTRICT_JS=1 -sWASM_BIGINT=1 -sPRINTF_LONG_DOUBLE=1 -sSUPPORT_LONGJMP=0 -sASSERTIONS=0 -g -sUSE_PTHREADS=1 -pthread -flto=thin -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=1400mb -sMALLOC="emmalloc" -ffast-math -sUSE_SDL=1 -Oz -Wno-unused-result -sFORCE_FILESYSTEM=1 -s USE_ZLIB=1 -I./include -I./libpcsxcore
LDFLAGS=
