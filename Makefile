CC=emcc
CXX=em++
CFLAGS= --closure 0 -sFULL_ES2=1 -sGL_TESTING=1 -D USESDLSOUND -Wpointer-sign -sFORCE_FILESYSTEM=1 -lidbfs.js \
-sOFFSCREEN_FRAMEBUFFER=1 -sELIMINATE_DUPLICATE_FUNCTIONS=1 -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=1400mb -sMALLOC="emmalloc" \
-sUSE_SDL=1 -O3 -Wno-unused-result -s USE_ZLIB=1 -I./include -I./libpcsxcore
LDFLAGS=
