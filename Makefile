CC=emcc
CXX=em++
CFLAGS= -sPROXY_TO_PTHREAD=1 -pthread -sUSE_PTHREADS=1 --closure 0 -sSUPPORT_BIG_ENDIAN=1 -sFULL_ES2=1 -sFULL_ES3=1 -sOFFSCREEN_FRAMEBUFFER=1 -sGL_TESTING=1 -D USESDLSOUND -Wpointer-sign -sFORCE_FILESYSTEM=1 -lidbfs.js \
-sELIMINATE_DUPLICATE_FUNCTIONS=1 -sALLOW_MEMORY_GROWTH=0 -sMALLOC="emmalloc"  -sINITIAL_MEMORY=1400mb -ffast-math \
-sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -O3 -Wno-unused-result -s USE_ZLIB=1 -I./include -I./libpcsxcore
LDFLAGS=
