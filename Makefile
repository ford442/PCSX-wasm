CC=emcc
CXX=em++
CFLAGS= -sFULL_ES2=1 -sFULL_ES3=1 -sGL_TESTING=1 -D USESDLSOUND -Wpointer-sign -sUSE_WEBGL2=1 -sMAX_WEBGL_VERSION=2 -sMIN_WEBGL_VERSION=1 \
-sOFFSCREEN_FRAMEBUFFER=1 -sELIMINATE_DUPLICATE_FUNCTIONS=1 -sMALLOC="emmalloc" \
