CC=emcc
CXX=em++
CFLAGS= --closure 0 -sFULL_ES2=1 -s FULL_ES3=1 -s WEBGL2_BACKWARDS_COMPATIBILITY_EMULATION=1 -sGL_TESTING=1 -s LEGACY_GL_EMULATION=1 -ffast-math -D USESDLSOUND -Wpointer-sign -sFORCE_FILESYSTEM=1 -lidbfs.js \
