CC=emcc
CXX=em++
CFLAGS= --closure 0 -sSUPPORT_BIG_ENDIAN=1 -sFULL_ES2=0 -sFULL_ES3=1 -sOFFSCREEN_FRAMEBUFFER=1 -sGL_TESTING=1 -D USESDLSOUND -Wpointer-sign -sFORCE_FILESYSTEM=1 -lidbfs.js \
