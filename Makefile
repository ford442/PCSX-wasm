CC=emcc
CXX=em++
CFLAGS= -pthread -sUSE_PTHREADS=1 -sPTHREAD_POOL_SIZE=2 --closure 0 -sSUPPORT_BIG_ENDIAN=1 -sFULL_ES2=1 -sFULL_ES3=0 -sOFFSCREEN_FRAMEBUFFER=1 -sGL_TESTING=1 -D USESDLSOUND -Wpointer-sign -sFORCE_FILESYSTEM=1 -lidbfs.js \
-sELIMINATE_DUPLICATE_FUNCTIONS=1 -sALLOW_MEMORY_GROWTH=0 -sMALLOC="emmalloc"  -sINITIAL_MEMORY=1400mb \
-sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=1 -sMAX_WEBGL_VERSION=2 -O3 -ffast-math -Wno-unused-result -sUSE_ZLIB=1 -I./include -I./libpcsxcore
LDFLAGS=
