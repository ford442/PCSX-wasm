CC=emcc
CXX=em++
CFLAGS= -sFULL_ES2=1 -sGL_TESTING=1 -D USESDLSOUND -Wpointer-sign  -sFORCE_FILESYSTEM=1 \
-sUSE_WEBGL2=1 -sOFFSCREEN_FRAMEBUFFER=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sELIMINATE_DUPLICATE_FUNCTIONS=1 \
-ffast-math -sUSE_SDL=1 -O3 -Wno-unused-result -lidbfs.js -s USE_ZLIB=1 -I./include -I./libpcsxcore -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=1400mb
LDFLAGS=
