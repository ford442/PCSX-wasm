CC=emcc
CXX=em++
CFLAGS= -pthread -s DISABLE_EXCEPTION_CATCHING=0 -D USESDLSOUND -Wpointer-sign -sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sAGGRESSIVE_VARIABLE_ELIMINATION=1 -sELIMINATE_DUPLICATE_FUNCTIONS=1 -sSTRICT_JS=1 -sWASM_BIGINT=1 -sPRINTF_LONG_DOUBLE=1 -sSUPPORT_LONGJMP=0 -sASSERTIONS=0 -g -flto=thin -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=1400mb -sMALLOC="emmalloc" -ffast-math -sUSE_SDL=1 -O2 -Wno-unused-result -sFORCE_FILESYSTEM=1 -s USE_ZLIB=1 -I./include -I./libpcsxcore
LDFLAGS=
