CC=emcc
CXX=em++
CFLAGS= -sENVIRONMENT=web --closure 0 -gsource-map --source-map-base -sSUPPORT_BIG_ENDIAN=1 -D USESDLSOUND -Wpointer-sign \
-sUSE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 -sELIMINATE_DUPLICATE_FUNCTIONS=1 \
-sPRINTF_LONG_DOUBLE=1 -sSUPPORT_LONGJMP=0 -flto=thin -sALLOW_MEMORY_GROWTH=0 -sINITIAL_MEMORY=1400mb \
-ffast-math -sUSE_SDL=1 -O0 -Wno-unused-result -sFORCE_FILESYSTEM=1 -s USE_ZLIB=1 -I./include -I./libpcsxcore
LDFLAGS=
