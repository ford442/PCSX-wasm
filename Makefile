CC=emcc
CXX=em++
CFLAGS= -sUSE_WEBGL2=1 -sFULL_ES2=1  -sFULL_ES3=1 -sGL_TESTING=1 -D USESDLSOUND -Wpointer-sign \
-sOFFSCREEN_FRAMEBUFFER=1 -sELIMINATE_DUPLICATE_FUNCTIONS=1 \
-ffast-math -sUSE_SDL=1 -O3 -Wno-unused-result -sFORCE_FILESYSTEM=1 -lidbfs.js -sUSE_ZLIB=1 -I./include -I./libpcsxcore
LDFLAGS=
